<template>
  <div class="space-y-6">
    <div class="space-y-2">
      <h1 class="text-4xl md:text-5xl font-bold bg-gradient-to-r dark:from-white dark:via-gray-100 dark:to-white from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent">
        {{ basics?.name }}
      </h1>
    ...
    <div class="flex flex-wrap gap-3 text-sm">
      ...
      >
        <Icon name="mdi:email" class="w-4 h-4 dark:text-gray-300 text-gray-600 dark:group-hover:text-white group-hover:text-gray-900 transition-colors" />
        <span class="dark:text-gray-300 text-gray-600 dark:group-hover:text-white group-hover:text-gray-900 transition-colors">{{ basics.email }}</span>
      </a>
      ...
      <a
        ...
        class="group flex items-center gap-2 px-4 py-2 rounded-xl dark:bg-white/5 bg-black/5 dark:hover:bg-white/10 hover:bg-black/10 dark:border-white/10 border-gray-300/30 dark:hover:border-white/20 hover:border-gray-400/40 backdrop-blur-sm transition-all duration-300 hover:scale-105"
      >
        <Icon name="mdi:phone" class="w-4 h-4 dark:text-gray-300 text-gray-600 dark:group-hover:text-white group-hover:text-gray-900 transition-colors" />
        <span class="dark:text-gray-300 text-gray-600 dark:group-hover:text-white group-hover:text-gray-900 transition-colors">{{ basics.phone }}</span>
      </a>
      ...
      <a
        ...
        class="group flex items-center gap-2 px-4 py-2 rounded-xl dark:bg-white/5 bg-black/5 dark:hover:bg-white/10 hover:bg-black/10 dark:border-white/10 border-gray-300/30 dark:hover:border-white/20 hover:border-gray-400/40 backdrop-blur-sm transition-all duration-300 hover:scale-105"
      >
        <Icon name="mdi:web" class="w-4 h-4 dark:text-gray-300 text-gray-600 dark:group-hover:text-white group-hover:text-gray-900 transition-colors" />
        <span class="dark:text-gray-300 text-gray-600 dark:group-hover:text-white group-hover:text-gray-900 transition-colors">{{ basics.url }}</span>
      </a>
    </div>
    ...
    <div v-if="basics?.profiles && basics.profiles.length > 0" class="flex flex-wrap gap-3">
      ...
      >
        <Icon
          :name="getProfileIcon(profile.network)"
        ...
        />
        <span class="dark:text-gray-300 text-gray-600 dark:group-hover:text-white group-hover:text-gray-900 transition-colors font-medium">{{ profile.network }}</span>
      </a>
    </div>
  </div>
</template>
